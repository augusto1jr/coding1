...
let cor_pulseira = prompt("Digite Vermelho para emergências, Amarelo para risco moderado, e Verde para situações controladas: ").toLowerCase()
...
let tema_pesquisa = prompt("Sobre qual tema deseja pesquisar? Filmes, Séries, Jogos ou Músicas? ").toLowerCase()

if (tema_pesquisa === "filmes"){
